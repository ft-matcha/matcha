...
ALTER TABLE `room` ADD FOREIGN KEY (`fromId`) REFERENCES `user`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `room` ADD FOREIGN KEY (`toId`) REFERENCES `user`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `message` ADD FOREIGN KEY (`roomId`) REFERENCES `room`(`roomId`) ON DELETE CASCADE ON UPDATE CASCADE;
